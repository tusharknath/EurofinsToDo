...
//                if (exceptionType == typeof(Error.APIException))
//                {
//                    var exception = record.Exception as Error.APIException;
//                    if (exception != null)
//                    {
...
//                    }
//                }
//                else if (exceptionType == typeof(Error.APIBusinessException))
//                {
//                    var exception = record.Exception as Error.APIBusinessException;
//                    if (exception != null)
//                    {
//                        message.Append("").Append("Error: " + exception.ErrorDescription + Environment.NewLine);
//                        message.Append("").Append("Error Code: " + exception.ErrorCode + Environment.NewLine);
//                    }
//                }
//                else if (exceptionType == typeof(Error.APIDataException))
//                {
//                    var exception = record.Exception as Error.APIDataException;
//                    if (exception != null)
//                    {
//                        message.Append("").Append("Error: " + exception.ErrorDescription + Environment.NewLine);
//                        message.Append("").Append("Error Code: " + exception.ErrorCode + Environment.NewLine);
